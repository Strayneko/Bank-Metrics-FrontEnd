<div class="relative w-full">
        ...
        <form class="flex cursor-pointer flex-col px-10" x-ref="updateBankForm" x-on:submit.prevent="updatedBank(bank.id)">
          ...
          <label for="loaning_percentage" class="relative w-full pb-3">
            ...
            <input type="number" name="loaning_percentage" id="loaning_percentage" class="peer mt-2 w-full outline-none"
              placeholder="Insert your loaning percentage" :value="bank.loaning_percentage" x-model="bank.loaning_percentage">
            <div
              class="absolute inset-x-0 bottom-0 mx-auto block h-0.5 w-0 rounded-lg bg-navy transition-all duration-300 peer-hover:w-full">
            </div>
          </label>
          ...
          <label for="marital_status" class="relative w-full pb-3">
            ...
            <select name="marital_status" id="marital_status"
              ...
              <option :selected="bank.marital_status ? (bank.marital_status == 0 ? true : false) : false" value="0" class="bg-white font-medium">Single Only</option>
              <option :selected="bank.marital_status ? (bank.marital_status == 1 ? true : false) : false" value="1" class="bg-white font-medium">Married Only</option>
              <option :selected="bank.marital_status ? (bank.marital_status == 2 ? true : false) : false" value="2" class="bg-white font-medium">Both</option>
            </select>
          </label>
          ...
          <label for="nationality" class="relative w-full pb-3">
            ...
            <select name="nationality" id="nationality"
              ...
              <option :selected="bank.nationality ? (bank.nationality == 0 ? true : false) : false" value="0" class="bg-white font-medium">Indonesia Only</option>
              <option :selected="bank.nationality ? (bank.nationality == 1 ? true : false) : false" value="1" class="bg-white font-medium">Foreigner Only</option>
              <option :selected="bank.nationality ? (bank.nationality == 2 ? true : false) : false" value="2" class="bg-white font-medium">Both</option>
            </select>
          </label>
          ...
          <label for="employment" class="relative w-full pb-3">
            ...
            <select name="employment" id="employment"
              ...
              <option :selected="bank.employment ? (bank.employment == 0 ? true : false) : false" value="0" class="bg-white font-medium">Half-Time</option>
              <option :selected="bank.employment ? (bank.employment == 1 ? true : false) : false" value="1" class="bg-white font-medium">Full-Time</option>
              <option :selected="bank.employment ? (bank.employment == 2 ? true : false) : false" value="2" class="bg-white font-medium">Both</option>
            </select>
          </label>
    ...
    <div class="fixed inset-0 z-10 bg-gray-1/40 backdrop-blur-sm" x-on:click="isShowUpdate = false"></div>
  </div>
