<div class="w-full">
    <div class="w-[575px] mb-48 mx-auto absolute inset-x-0 z-40">
        <div class="relative bg-white pt-8  rounded-xl">
            ...
            <form x-on:submit.prevent="create()" class="px-[39px] flex flex-col cursor-pointer">
                <label for="name" class="relative pb-3 w-full">
                    <p class="font-bold text-navy">Name</p>
                    <input type="text" name="name" id="name" class="peer outline-none mt-2" placeholder="Insert your name" x-model="newAdmin.name">
                ...
                <label for="email" class="relative pb-3 w-full">
                    ...
                    <input type="text" name="email" id="email" class="peer outline-none mt-2" placeholder="Insert your email address" x-model="newAdmin.email">
                    <div class="absolute inset-x-0 bottom-0 mx-auto block h-1 w-0 bg-navy peer-hover:w-full rounded-lg transition-all duration-500"></div>
                </label>
                <label for="password" class="relative pb-3 w-full">
                    <p class="font-bold text-navy">Password</p>
                    <input type="password" name="password" id="password" class="peer outline-none mt-2" placeholder="Insert your password" x-model="newAdmin.password">
                    <div class="absolute inset-x-0 bottom-0 mx-auto block h-1 w-0 bg-navy peer-hover:w-full rounded-lg transition-all duration-500"></div>
                </label>
