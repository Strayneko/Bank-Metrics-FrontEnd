    ...
    <div class="w-[575px] mb-48 mx-auto absolute inset-x-0 z-40">
        <div class="relative bg-white pt-8  rounded-xl">
            ...
            <form class="px-[39px] flex flex-col cursor-pointer">
                ...
                <label for="loangin_percentage" class="relative pb-3 w-full">
                    <p class="font-bold text-navy">Loaning Percentage</p>
                    <input type="text" name="loangin_percentage" id="loangin_percentage" class="peer outline-none mt-2" placeholder="Insert your loaning percentage">
                    <div class="absolute inset-x-0 bottom-0 mx-auto block h-1 w-0 bg-navy peer-hover:w-full rounded-lg transition-all duration-500"></div>
                </label>
                <label for="min_age" class="relative pb-3 w-full">
                    <p class="font-bold text-navy">Min Age</p>
                    <input type="text" name="min_age" id="min_age" class="peer outline-none mt-2" placeholder="Insert your min age">
                    <div class="absolute inset-x-0 bottom-0 mx-auto block h-1 w-0 bg-navy peer-hover:w-full rounded-lg transition-all duration-500"></div>
                </label>
                <label for="max_age" class="relative pb-3 w-full">
                    <p class="font-bold text-navy">Max Age</p>
                    <input type="text" name="max_age" id="max_age" class="peer outline-none mt-2" placeholder="Insert your max age">
                    <div class="absolute inset-x-0 bottom-0 mx-auto block h-1 w-0 bg-navy peer-hover:w-full rounded-lg transition-all duration-500"></div>
                </label>
