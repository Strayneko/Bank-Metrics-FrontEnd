...
<section class="absolute inset-x-0 mx-auto w-full pb-12">
    <div class="relative z-20 mx-auto mr-40 mt-40 w-3/5 rounded-xl bg-white p-10 shadow-md shadow-navy/60">
        <div class="relative mx-auto mb-6 flex w-max flex-col items-center justify-center gap-3">
            ...
            <div class="relative h-2 w-72 rounded-lg bg-orange-1 after:absolute after:inset-0 after:m-auto after:h-5 after:w-16 after:rounded-xl after:bg-navy">
            </div>
        </div>
        ...
        <a x-on:click="showDetail = false" class="rounded-lg bg-[#f1f0f0] px-20 py-3 font-bold text-navy outline outline-orange-1 hover:bg-orange-1 hover:text-white">Back</a>
    </div>
