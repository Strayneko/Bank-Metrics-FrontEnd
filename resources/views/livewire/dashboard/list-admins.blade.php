...
getProfile()">
    ...
    <section class="mt-20 w-full py-10 lg:mt-0 lg:w-[80%]">
        <div class="relative mx-auto w-11/12 rounded-xl pb-6 lg:mx-0 lg:w-full lg:bg-gray-1 lg:p-6 lg:pt-12" x-data="{ isAddActive: false }">
            ...
            <div class="w-full" x-show="isAddActive" x-transition.duration.500ms x-data="createAdmin" x-init="checkLogged()">
